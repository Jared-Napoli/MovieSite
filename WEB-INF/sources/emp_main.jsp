...
<HTML>
    ...
    <div style="font-family: Verdana; font-weight: bold; font-size: 14px; padding:10px;">
        <FORM ACTION="/project4/employee/insert_star" METHOD="get">
    ...
    <h2>Get Metadata:<h2>
        <FORM ACTION="/project4/employee/meta_data" METHOD="get">
    ...
    <div style="font-family: Verdana; font-weight: bold; font-size: 14px; padding:10px;">
        <FORM ACTION="/project4/employee/add_movie" METHOD="get">
